...
const ContactEvents_1 = __importDefault(require("./api/ContactEvents"));
const ContactExports_1 = __importDefault(require("./api/ContactExports"));
const ContactFields_1 = __importDefault(require("./api/ContactFields"));
const ContactImports_1 = __importDefault(require("./api/ContactImports"));
...
const SendingDomains_1 = __importDefault(require("./api/SendingDomains"));
...
class MailtrapClient {
    ...
    get testing() {
        ...
        return new Testing_1.default(this.axios, accountId);
    }
    /**
    ...
    get general() {
        const accountId = this.validateAccountIdPresence();
        return new General_1.default(this.axios, accountId);
    }
    /**
    ...
    get contacts() {
        const accountId = this.validateAccountIdPresence();
        return new Contacts_1.default(this.axios, accountId);
    }
    /**
    ...
    get contactEvents() {
        const accountId = this.validateAccountIdPresence();
        return new ContactEvents_1.default(this.axios, accountId);
    }
    /**
    ...
    get contactExports() {
        const accountId = this.validateAccountIdPresence();
        return new ContactExports_1.default(this.axios, accountId);
    }
    /**
    ...
    get contactLists() {
        const accountId = this.validateAccountIdPresence();
        return new ContactLists_1.default(this.axios, accountId);
    }
    /**
    ...
    get contactFields() {
        const accountId = this.validateAccountIdPresence();
        return new ContactFields_1.default(this.axios, accountId);
    }
    /**
    ...
    get contactImports() {
        const accountId = this.validateAccountIdPresence();
        return new ContactImports_1.default(this.axios, accountId);
    }
    /**
    ...
    get templates() {
        const accountId = this.validateAccountIdPresence();
        return new Templates_1.default(this.axios, accountId);
    }
    /**
    ...
    get suppressions() {
        const accountId = this.validateAccountIdPresence();
        return new Suppressions_1.default(this.axios, accountId);
    }
    /**
    ...
    get sendingDomains() {
        const accountId = this.validateAccountIdPresence();
        return new SendingDomains_1.default(this.axios, accountId);
    }
    /**
