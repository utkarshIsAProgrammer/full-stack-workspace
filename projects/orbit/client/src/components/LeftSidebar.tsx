			...
			<div className="hidden lg:flex flex-col h-[calc(100vh-3rem)] sticky top-6">
				<GlassCard
					...
					<div className="space-y-5 pb-5">
						{/* Logo */}
						<div
							className="cursor-pointer pt-1 group"
							onClick={() => setTab("home")}>
								...
								return (
									<button
										...
										<div className="relative">
											<Icon
												className={`h-4.5 w-4.5 ${active ? "opacity-100" : "opacity-70"}`}
												aria-hidden="true"
											/>
											{tab.badge ? (
												<span
					...
					<div className="mt-auto pt-5 border-t border-white/10">
						<button
							...
							/>
							<div className="hidden flex-1 shrink-0 flex-col items-start md:flex overflow-hidden text-left">
