...
export const sendMessage = async (
	...
	try {
		...
		if (!isRecipientActive) {
			...
			// Fetch the full populated conversation for the notification
			// so the recipient can add it to their conversations list if it doesn't exist yet
...
export const deleteMessageForMe = async (
	...
	try {
		...
		// Clear chat cache
		await clearChatCache(message.conversation.toString(), participantsStr);
