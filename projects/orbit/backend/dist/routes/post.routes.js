...
router.post("/", auth_middleware_1.protect, upload_middleware_1.default.single("image"), ratelimit_middleware_1.interactionLimiter, post_controllers_1.createPost);
router.put("/:postId", auth_middleware_1.protect, upload_middleware_1.default.single("image"), ratelimit_middleware_1.interactionLimiter, post_controllers_1.updatePost);
