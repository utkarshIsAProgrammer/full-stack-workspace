...
router.get("/:userId/followers", auth_middleware_1.optionalAuth, (0, cache_middleware_1.cacheMiddleware)({ ttl: 120 }), follow_controllers_1.getFollowers);
router.get("/:userId/following", auth_middleware_1.optionalAuth, (0, cache_middleware_1.cacheMiddleware)({ ttl: 120 }), follow_controllers_1.getFollowing);
