...
router.post("/forgot", ratelimit_middleware_1.otpLimiter, password_controllers_1.requestOtpForForgotPassword); // Client alias
...
router.post("/reset", ratelimit_middleware_1.authLimiter, password_controllers_1.verifyOtpAndForgotPassword); // Client alias
